...
function license() {
  function _0x525f01(_0x5737d9) {
    ...
    if (_0x35fe79(_0x5737d9)) {
      _0x5737d9 = atob(_0x5737d9)
      _0x5737d9 = _0x5737d9.replaceAll('XXX', '.')
      _0x5737d9 = _0x5737d9.replaceAll('YY', '-')
      _0x5737d9 = _0x5737d9.replaceAll('O5', 'a')
      _0x5737d9 = _0x5737d9.replaceAll('E4', 'i')
      _0x5737d9 = _0x5737d9.replaceAll('U3', 'u')
      _0x5737d9 = _0x5737d9.replaceAll('I2', 'e')
      _0x5737d9 = _0x5737d9.replaceAll('A1', 'o')
      function _0x37d0dd(_0x21f7ed) {
        const _0x398938 = _0x21f7ed.split(''),
          _0x50d810 = _0x398938.reverse(),
          _0x1e32b0 = _0x50d810.join('')
        return _0x1e32b0
      }
  ...
  function _0xfd2318(_0x8bc47e) {
    ...
    return (document.body.innerHTML = _0x9d8ec4)
  }
  if (typeof $license_key === 'undefined') {
    _0xfd2318('Dilarang menghapus variable <b>$license_key</b>..')
  } else {
    if (typeof $license_item === 'undefined') {
      _0xfd2318('Dilarang menghapus variable <b>$license_item</b>..')
    } else {
      if (
        ...
        console.log(
          'Developed by. https://infinityloomlab.com ( Free / Trial Version )'
        )
        var _0x3e1f6b = document.getElementById('copyright')
        if (_0x3e1f6b === null) {
          _0xfd2318(
            '<b>Respect Copyright</b><br><br><small>Use "Premium License" to remove credit.</small><br><br><small>#ERR_COPYRIGHT</small>'
          )
        } else {
          var _0x279a14 = new Date().getFullYear()
          _0x3e1f6b.innerHTML =
            '&#0169;' +
            _0x279a14 +
            ' &#8212; Made with. <a href="https://infinityloomlab.com/' +
            $license_item +
            '" target="_blank"><b>InfinityLoom Lab</b></a>'
          _0x3e1f6b.setAttribute(
            'style',
        ...
        if ($license_key === '') {
          _0xfd2318(
            '<b>License Code</b> required..<br><br><small>#ERR_LICENSE</small>'
          )
        } else {
          const _0x538dfc = _0x525f01($license_key).split('|')[0],
            _0x4f4ddc = _0x525f01($license_key).split('|')[1]
          if (_0x538dfc == '' || _0x538dfc == undefined) {
            _0xfd2318(
              'The <b>License Code</b> used is invalid.</b><br><br><small>#ERR_KEY</small>'
            )
          } else {
            if (location.hostname.indexOf(_0x538dfc) == -1) {
              _0xfd2318(
                '<b>License Code</b> can only be used on websites with the domain: <b>' +
                  _0x538dfc +
              ...
              if (_0x4f4ddc != $license_item) {
                function _0x145389(_0x3243a4) {
                  ...
                  for (
                    ...
                    _0x3243a4[_0x575e24] =
                      _0x3243a4[_0x575e24].charAt(0).toUpperCase() +
                      _0x3243a4[_0x575e24].slice(1)
                  }
                  return (_0x3243a4 = _0x3243a4.join(' ')), _0x3243a4
                }
                _0xfd2318(
                  '<b>License Code</b> can only be used for <b>' +
                    _0x145389($license_item.replaceAll('-', ' ')) +
                    '</b><br><br><small>#ERR_ITEM</small>'
                )
              } else {
                console.log(
                  'Developed by. https://infinityloomlab.com ( Premium Version )'
                )
              }
            }
          }
...
$(document).ready(function () {
  ...
  $('.formWA [type=email]').each(function () {
    $(this)
      .attr('type', 'tel')
      .attr('placeholder', 'Active Number..')
      .removeClass('email')
      .addClass('hp')
    $(this)
      .closest('.item')
    ...
    $(this).closest('.item').find('.validasi b').text('Active Number..')
  })
